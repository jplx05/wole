...
- `src/`: Rust library and CLI implementation. Key areas include `src/cleaner.rs` (deletion logic), `src/categories/` (scan/clean per category), and `src/tui/` (terminal UI).
